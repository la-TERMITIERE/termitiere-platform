...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-xl bg-gradient-to-r from-teal-600 to-teal-900 p-4 text-white">
        <h2 className="text-lg font-extrabold">Gestion de Projet</h2>
        <p className="text-sm text-teal-200">Suivi des projets · Tâches · Équipes · Avancement</p>
      </div>
